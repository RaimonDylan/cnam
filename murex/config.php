...
class DB
{
	...
	private static $dbhost = "famebattdwadmin.mysql.db"; 
	private static $dbuname = "famebattdwadmin"; // login
	private static $dbpass = "Azertyuiop1"; // mot de passe
	private static $dbname = "famebattdwadmin"; // nom de la base de données
	////////////////////////////////////////////////////////////////////////////
